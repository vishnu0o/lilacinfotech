...
function Sidenavbar() {
    return (
        ...
        <div className=' flex fixed h-screen flex-col space-y-3 py-20 sm:w-1/12 lg:w-1/5 w-1/5 pb-[140px] bg-blue-950'>
            <NavLink to={'/home'} activeClassName='rounded-l-full text-black bg-white' className='sm:ml-2 lg:ml-8 flex w-auto mt-10  border-b-2 border-b-slate-700 py-3  px-4 hover:rounded-l-full  text-white hover:text-black hover:bg-white border-slate-500 '>
                <div className=''>
                    <CgProfile className=' w-7 h-7 text-pink-600' />
                </div>
                <div className='pl-3 sm:hidden lg:block text-lg font-bold  '>Add Students</div>
            </NavLink>
            <NavLink to={'/students'} className='sm:ml-2 lg:ml-8 flex w-auto  border-b-2 border-b-slate-700 py-3 px-4   hover:rounded-l-full text-white hover:text-black hover:bg-white border-slate-500'>
                <div className=''>
                    <BsCardList className=' w-7 h-7 text-pink-600' />
                </div>
                <div className='pl-3 sm:hidden lg:block text-lg font-bold '>All Students</div>
            </NavLink>
