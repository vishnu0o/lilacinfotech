...
function signup() {
    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row h-screen relative">
            ...
            <div className="flex absolute bg-white rounded-lg z-20 md:static md:h-auto mx-12 mt-44 md:my-0 flex-col md:justify-center items-center justify-around md:pl-6 md:py-10 md:mx-5 lg:mx-0 lg:w-1/3">
                <div className=' flex flex-col items-center md:items-start md:w-full md:pl-12'>
                    <div className='md:block hidden'>
                        <img className="w-20" src="images/logo1.png" alt="" />
                    </div>
                    <div className="font-bold text-3xl pt-2 text-center md:text-start">Sign up</div>
                </div>
                ...
                <form action="" className="mt-4 md:p-0 p-2 f md:pl-4 w-[320px] md:w-fit space-y-2">
                    <div className="relative md:w-96 ">
                        <label htmlFor="" className="bg-white absolute top-3 left-3 px-2">Name <span className="text-red-500">*</span></label><br />
                        <input placeholder="Name" className="pl-4 placeholder border-2 border-gray-300 w-full h-14 rounded-lg" type="text" />
                    </div>
                    ...
                    <button className="text-center h-12 w-full pt-3 bg-blue-950 text-white py-4 rounded-lg font-bold">Signup</button>
                    <div className="relative">
                        <img className="w-6 absolute top-4  left-10 md:left-14" src="images/google.png" alt="" />
                        <button className="text-center h-14 w-full pt-3 bg-white border-2 border-gray-300 shadow-sm text-gray-500 py-4 rounded-lg font-bold">Login with Google</button>
                    </div>
                </form>
